...
public class cmd {
    ...
    public static void main(String[] args) {
        ...
        //  String[] another = { "cmd","/k","java -version"};
        String[] another = { "cmd java -version" };
        String[] another1 = { "cmd /c start cmd.exe /k java -version" };
        //  String s=runCmd(another,another1);
        //  System.out.println(System.getProperty("os.name").toLowerCase());
        String line = "";
        try {
            Runtime rt = Runtime.getRuntime();
            Process proc = rt.exec("cmd /c start cmd.exe /k java -version");
    ...
    */
    ...
    private static String runCmd(String[] cmd, String[] another) {
        String result = "";
        String line = "";
        try {
            Runtime rt = Runtime.getRuntime();
